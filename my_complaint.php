                    ...
                    <table class="complaints-table student-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="bold-title"><?= $complaint["complaint_title"] ?></td>
                                <td><?= $complaint["category"] ?></td>
                                <td><?= $complaint["create_at"] ?></td>
                                <td><span class="status-student badge-<?= $complaint["status"] ?>-v2"><span class="dot"></span><?= $complaint["status"] ?> </span></td>
                                <td><a href="student_complaint.php?complaint_id=<?= $complaint["complaint_id"] ?>" class="view-link">Vieww</a></td>
                            </tr>
                            <?php endforeach; ?>
                            <!-- <tr>
                                <td>#C-1246</td>
